# Visit 3.2.0 log file
ScriptVersion = "3.2.0"
if ScriptVersion != Version():
    print "This script is for VisIt %s. It may not work with version %s" % (ScriptVersion, Version())
ShowAllWindows()
Source("/usr/local/visit/3.2.0/linux-x86_64/bin/makemovie.py")
...
SaveWindowAtts.outputDirectory = "/home/jamal/deal/deal.II-v9.2.0/examples/phasefieldcrackdynamicfracture/movie-0"
